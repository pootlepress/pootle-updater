...
$pluginsInfo = array(
    ...
    'cx-sticky-nav-master' => array(
        ...
        'latest-version' => '1.2',
        'description' => '<li>v1.2 - ability to update within WordPress</li>'
    ),
    'cx-page-customizer-master' => array(
        'product-id' => 14480,
        'name' => 'Canvas Extension - Page Customizer',
        'latest-version' => '1.2.1',
        'description' => '<li>1.2.1 - Fix "Pages & posts" options</li><li>1.2 - add ability to update in WordPress dashboard, Fix center alignment in mobile</li><li>1.1 - fix layout saving issue, bg color not over-riding & header image issue</li><li>v1.0 - Initial Release</li>'
    ),
    'page-builder-for-canvas-master' => array(
        'product-id' => 13731,
        'name' => 'Canvas Extension - Page Builder for Canvas',
        'latest-version' => '1.1.1',
        'description' => '<li>1.1.1 - Fix bottom margin for row</li><li>1.1. - ability to update within WordPress</li>'
    ),
